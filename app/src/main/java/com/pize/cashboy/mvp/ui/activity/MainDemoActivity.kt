...
/**
 *@fileName MainDemoActivity
 *@author wangxiaodong
 *@data 2018/4/28 下午4:05
 *@describe TODO
 */
class MainDemoActivity : BaseActivity(), MainContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun layoutId(): Int = R.layout.activity_main_demo
